...
const components = [
	{
		js: () => Promise.all([import('./index.b5671a07.js'), __inject_styles(["index-b1bc306f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./signUp.6d5c9cbe.js'), __inject_styles(["signUp-02f5aeda.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.8b94b6cf.js'), __inject_styles(["login-a74e0c73.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[id].1d4a8e31.js'), __inject_styles(["[id]-27169cb8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./list.41ef0686.js'), __inject_styles(["list-6c49643a.css"])]).then(function(x) { return x[0]; })
	}
];
