...
const components = [
	{
		js: () => Promise.all([import('./index.e34d2443.js'), __inject_styles(["index-b5ef5fc2.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./signUp.7b4e82ce.js'), __inject_styles(["signUp-02f5aeda.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.c939c7c4.js'), __inject_styles(["login-a74e0c73.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[id].2bfe2865.js'), __inject_styles(["[id]-27169cb8.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./list.b44a5ae1.js'), __inject_styles(["list-6c49643a.css"])]).then(function(x) { return x[0]; })
	}
];
